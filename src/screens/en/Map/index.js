    ...
    return (
        ...
        >
            ...
            <View style={styles.content}>
                <Text style={styles.nameUp}>Tourist Map of</Text>
                <Text style={styles.name}>Baños Ecuador</Text>

                <TouchableHighlight
                    underlayColor={colors.BG}
                    activeOpacity={0.8}
                    onPress={ () => navigation.navigate('ViewMapEn') }
                >
                    <>
                        <Image
                        ...
                        <View style={styles.zoomBtn}>
                            ...
                            <Text style={styles.txtZoom}>Click to Zoom</Text>
                        </View>
                    </>
                </TouchableHighlight>
                ...
                <TouchableHighlight
                    underlayColor={colors.BG}
                    activeOpacity={0.8}
                    onPress={ () => navigation.navigate('ViewMappEn') }
                    style={{ marginTop: 30 }}
                >
                    <>
                        <Image
