                    ...
                    <FlatList
                        ...
                        ListHeaderComponent={ () => (
                            <View>
                                ...
                                <Text style={styles.welcomeUp}>Important</Text>
                                <Text style={styles.welcomeDown}>News</Text>
                            </View>
                        )}
                        renderItem={({ item }) => (
                            <TouchableHighlight 
                                ...
                                onPress={() => navigation.navigate('NewInfoEn', { item })}
                                activeOpacity={0.8}
                            >
                                <View style={{ flexDirection: 'row', alignItems: 'center'}}>
                                    ...
                                    <View style={{ flex: 1, marginLeft: 10 }}>
                                        <Text style={styles.txtName}>{item.title_en}</Text>
