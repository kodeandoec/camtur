...
import useGetByTagSearchEn from '../../../hooks/useGetByTagSearchEn';
...
const Search = ( { navigation }) => {
    ...
    const { state, getCommercesByTag, loading } = useGetByTagSearchEn();
                        ...
                        return (
                            item.type === 'commerceFull' ? (
                                <TouchableHighlight 
                                    ...
                                    onPress={() => navigation.navigate('CommerceEn', { item })}
                                    activeOpacity={0.8}
                                >
